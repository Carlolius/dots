...
wk.add({
    ...
    { "<leader>li", vim.diagnostic.open_float, desc = "Diagnostic detail" },
    { "<leader>ln", function() vim.diagnostic.jump({ count = 1 }) end, desc = "Next diagnostic" },
    { "<leader>lp", function() vim.diagnostic.jump({ count = -1 }) end, desc = "Prev diagnostic" },
